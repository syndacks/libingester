...
class ImageAsset extends BaseAsset {
    ...
    _process() {
        ...
        return Promise.resolve(this._image_data).then(data => {
            verify.verify_image_data(data);
            return data;
        });
    }
...
class DictionaryAsset extends BaseAsset {
    constructor() {
        super();
        this._object_type = "DictionaryObject";
        this._content_type = "text/html";
    }

    set_word (value) { this._word = value; }
    set_word_definition (value) { this._word_definition = value; }
    ...
    to_metadata() {
        ...
        Object.assign(metadata, {
            'word': this._word,
            'wordDefinition': this._word_definition,
    ...
    render() {
        ...
        let document = mustache.render(template, {
            word: this._word,
            word_definition: this._word_definition,
