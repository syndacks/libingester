...
class BaseAsset {
    ...
    to_metadata() {
        return {
            ...
            "thumbnail": this._thumbnail_asset_id,
...
class ImageAsset extends BaseAsset {
    ...
    _get_outgoing_asset_ids() { return super._get_outgoing_asset_ids(); }
}
...
class NewsArticle extends BaseAsset {
    ...
    _get_outgoing_asset_ids() {
        const ids = super._get_outgoing_asset_ids();
        this._document.find('[data-soma-job-id]').each(function() {
            ids.push(cheerio(this).attr('data-soma-job-id'));
        });
        return ids;
    }
}
